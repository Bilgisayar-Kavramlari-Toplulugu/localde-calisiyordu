...
Bu belge **localde çalışıyordu Yazılım/Programlama grubu tarafından hazırlanan bültenleri yayınlamak için kullanılan bir statik websitesidir.** projesinin amacını, hedeflerini ve kapsamını tanımlar.
