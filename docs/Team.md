# localde-calisiyordu Takımı ve Rolleri (Örnek)
<details open>
...
### ➡️ [Güncel Takım Listesi İçin Tıkla](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/localde-calisiyordu)

---
## 📊 Takım İstatistikleri

- **Proje Adı:** localde çalışıyordu Yazılım/Programlama grubu tarafından hazırlanan bültenleri yayınlamak için kullanılan bir statik websitesidir.
- **Takım Adı:** localde-calisiyordu
- **Proje Lideri:** @gecicidegisken
- **Toplam Üye Sayısı:** 1
- **Maintainer Sayısı:** 0
- **Member Sayısı:** 1
...
### ➡️ [Click Here for the Current Team List](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/localde-calisiyordu)

---

## 📊 Team Statistics

- **Project Name:** localde çalışıyordu Yazılım/Programlama grubu tarafından hazırlanan bültenleri yayınlamak için kullanılan bir statik websitesidir.
- **Team Name:** localde-calisiyordu
- **Project Lead:** @gecicidegisken
- **Total Members:** 1
- **Maintainers:** 0
- **Members:** 1
